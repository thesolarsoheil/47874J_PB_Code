...
void autonomous() {
	...
	case 0:
	{
		...
		moveto_point(22, 22, 500, {.forwards = false, .minSpeed = 10, .earlyExitRange = 2}, false);
		turnto_heading(180, 800, {.minSpeed = 10, .earlyExitRange = 2}, false);
		...
		chassis.moveToPoint(22, -22, 1000, {.minSpeed = 30, .earlyExitRange = 3});
		intake_high(127);
		...
		moveto_stack(22, -22);
		scraper.set_value(true);
		swingto_point(48, -42, lemlib::DriveSide::LEFT, 2000, {.minSpeed = 70, .earlyExitRange = 10}, false);
		moveto_point(48, -42, 2000, {.minSpeed = 15, .earlyExitRange = 2}, false);
		intake_high(127);
		ears.set_value(true);
		...
		hood.set_value(false);
		intake_high(127);
		swingto_point(-23, -60, lemlib::DriveSide::LEFT, 1000, {.forwards = false, .minSpeed = 80, .earlyExitRange = 10}, false);
		//simple_dist_reset();

		scraper.set_value(false);
		moveto_point(-23, -60, 3000, {.forwards = false, .minSpeed = 80, .earlyExitRange = 4});
		
		//move to 2nd matchloader
		//turnto_point(-44, 48, 2000, {.forwards = false, .minSpeed = 10, .earlyExitRange = 5}, false);
		moveto_point(-46, -44, 600, {.forwards = false, .minSpeed = 60, .earlyExitRange = 6});
		scraper.set_value(true);
		intake_high(127);
		...
		hood.set_value(false);
		intake_high(127);
		swingto_point(23, 62, lemlib::DriveSide::LEFT, 1000, {.forwards = false, .minSpeed = 80, .earlyExitRange = 10}, false);
		//simple_dist_reset();

		scraper.set_value(false);
		moveto_point(23, 62, 3000, {.forwards = false, .minSpeed = 80, .earlyExitRange = 4});
		
		//move to 4th matchloader
		//turnto_point(-44, 48, 2000, {.forwards = false, .minSpeed = 10, .earlyExitRange = 5}, false);
		moveto_point(42, 48 , 600, {.forwards = false, .minSpeed = 60, .earlyExitRange = 4});
		scraper.set_value(true);
		intake_high(127);
	...
	{		
		...
		chassis.moveToPose(27, -32, 270, 2000, {.forwards = false, .minSpeed = 100, .earlyExitRange = 3});

		moveto_point(36, -50, 2000, {.forwards = false, .minSpeed = 30, .earlyExitRange = 4});
		turnto_point(0, -56, 2000, {.forwards = false, .minSpeed = 1});
		chassis.moveToPoint(0, -56, 500, {.forwards = false});
		pros::Task::delay(200);
		hood.set_value(true);
		pros::Task::delay(1200);
		scraper.set_value(false);
